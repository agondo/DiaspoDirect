...
{
    /// <inheritdoc />
    public partial class AddSendPrescriptions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "SendPrescriptions",
                columns: table => new
                {
                    ...
                    RecipientFirstLastName = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SendPrescriptions", x => x.Id);
                });
        }
